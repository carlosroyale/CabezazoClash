...
<head>
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars($asset('juego/juego.css?v=13'), ENT_QUOTES, 'UTF-8') ?>">
...
<script src="<?= htmlspecialchars($asset('juego/js/online.js?v=18'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/main.js?v=31'), ENT_QUOTES, 'UTF-8') ?>"></script>
</body>
</html>
