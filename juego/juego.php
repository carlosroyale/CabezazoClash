...
<script src="<?= htmlspecialchars($asset('juego/js/physics.js?v=13'), ENT_QUOTES, 'UTF-8') ?>"></script>
...
<script src="<?= htmlspecialchars($asset('juego/js/game.js?v=14'), ENT_QUOTES, 'UTF-8') ?>"></script>
