...
<script src="<?= htmlspecialchars($asset('juego/js/entities.js?v=10'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/physics.js?v=16'), ENT_QUOTES, 'UTF-8') ?>"></script>
