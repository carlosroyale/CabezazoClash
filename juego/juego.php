...
<script src="<?= htmlspecialchars($asset('juego/js/physics.js?v=8'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/renderer.js?v=4'), ENT_QUOTES, 'UTF-8') ?>"></script>
