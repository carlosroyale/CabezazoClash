...
<script src="<?= htmlspecialchars($asset('juego/js/entities.js?v=8'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/physics.js?v=12'), ENT_QUOTES, 'UTF-8') ?>"></script>
