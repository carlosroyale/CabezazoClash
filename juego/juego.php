...
<script src="<?= htmlspecialchars($asset('juego/js/entities.js?v=14'), ENT_QUOTES, 'UTF-8') ?>"></script>
...
<script src="<?= htmlspecialchars($asset('juego/js/online.js?v=30'), ENT_QUOTES, 'UTF-8') ?>"></script>
