...
<script src="<?= htmlspecialchars($asset('juego/js/physics.js?v=9'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/renderer.js?v=5'), ENT_QUOTES, 'UTF-8') ?>"></script>
