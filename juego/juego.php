...
<div id="game-wrap" class="game-wrap">
        ...
        <div class="hud">
            ...
            <div class="tv-scoreboard-wrap">
                ...
                <div class="tv-scoreboard" id="scoreboard">
                    <div class="sb-time" id="timer">90</div>
    ...
    <section id="pause-menu" class="pause-menu hidden">
        <div class="card">
            ...
            <div id="pause-waiting-msg" class="hidden" style="margin-top: 2rem;">
                <div class="spinner" style="margin: 0 auto 15px auto; width: 40px; height: 40px;"></div>
                <h3 style="color: #ffce00; font-size: 1.6rem; font-weight: bold; text-transform: uppercase;">Esperando al rival...</h3>
            </div>
...
<script src="<?= htmlspecialchars($asset('juego/js/constants.js?v=6'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/entities.js?v=13'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/physics.js?v=20'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/renderer.js?v=8'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/input.js?v=6'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/game.js?v=16'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/online.js?v=26'), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars($asset('juego/js/main.js?v=41'), ENT_QUOTES, 'UTF-8') ?>"></script>
</body>
</html>